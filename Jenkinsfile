pipeline {
    ...
    environment {
        ...
        PROJECT_KEY = 'ErickJuniorFloresLizarbe_ms-beneficiary-education'  // Nombre corregido del proyecto en SonarCloud
        ...
        stage('Clone Repository') {
            steps {
                script {
                    ...
                    git branch: 'main', url: 'https://github.com/ErickJuniorFloresLizarbe/ms-beneficiary-education.git'
                }
            }
        }
                    ...
                    withSonarQubeEnv("${env.SONARQUBE}") {
                        sh '''
                            mvn sonar:sonar \
                                ...
                                -Dsonar.projectName=ms-beneficiary-education \
